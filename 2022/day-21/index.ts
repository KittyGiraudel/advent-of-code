...
export const getRootNumber = (input: Map | Array<string>): number => {
...
export const getHumnNumberByBruteForce = (input: Array<string>) => {
...
// what I’ve done.
export const getHumnNumber = (input: Array<string>) => {
