...
// prettier-ignore
const ERIS_MAP = [
  [[ 7, OL], [11, OL], [ 5, CL], [ 1, CL]], // 0
  [[ 7, OL], [ 0, CL], [ 6, CL], [ 2, CL]], // 1
  [[ 7, OL], [ 1, CL], [ 7, CL], [ 3, CL]], // 2
  [[ 7, OL], [ 2, CL], [ 8, CL], [ 4, CL]], // 3
  [[ 7, OL], [ 3, CL], [ 9, CL], [13, OL]], // 4
  [[ 0, CL], [11, OL], [10, CL], [ 6, CL]], // 5
  [[ 1, CL], [ 5, CL], [11, CL], [ 7, CL]], // 6
  [
    [ 2, CL], [ 6, CL],
    [ 0, IL], [ 1, IL], [ 2, IL], [ 3, IL], [ 4, IL],
    [ 8, CL]
  ],                                        // 7
  [[ 3, CL], [ 7, CL], [13, CL], [ 9, CL]], // 8
  [[ 4, CL], [ 8, CL], [14, CL], [13, OL]], // 9
  [[ 5, CL], [11, OL], [15, CL], [11, CL]], // 10
  [
    [ 6, CL], [10, CL], [16, CL],
  ...
  [[ 9, CL], [13, CL], [19, CL], [13, OL]], // 14
  [[10, CL], [11, OL], [20, CL], [16, CL]], // 15
  [[11, CL], [15, CL], [21, CL], [17, CL]], // 16
  [
    [20, IL], [21, IL], [22, IL], [23, IL], [24, IL],
    [16, CL], [22, CL], [18, CL]
  ],                                        // 17
  [[13, CL], [17, CL], [23, CL], [19, CL]], // 18
  [[14, CL], [18, CL], [24, CL], [13, OL]], // 19
  [[15, CL], [11, OL], [17, OL], [21, CL]], // 20
  [[16, CL], [20, CL], [17, OL], [22, CL]], // 21
  [[17, CL], [21, CL], [17, OL], [23, CL]], // 22
  [[18, CL], [22, CL], [17, OL], [24, CL]], // 23
